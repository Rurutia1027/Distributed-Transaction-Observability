...
@Setter
@Entity
@Table(name = "rms_message_tx", indexes = {
        @Index(name = "idx_rms_status_next_retry", columnList = "status,nextRetryAt"),
        @Index(name = "idx_rms_biz_event", columnList = "bizKey,eventType")
})
