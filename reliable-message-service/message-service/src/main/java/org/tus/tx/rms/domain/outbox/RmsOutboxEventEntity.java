...
@Setter
@Entity
@Table(name = "rms_outbox_event", indexes = {
        @Index(name = "idx_outbox_status_next", columnList = "status,nextRetryAt"),
        @Index(name = "idx_outbox_ready", columnList = "readyToSend,status")
})
public class RmsOutboxEventEntity {
    ...
    @Column(name = "ready_to_send", nullable = false)
